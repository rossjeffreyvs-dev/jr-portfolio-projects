...
// const API_BASE =
//   process.env.NEXT_PUBLIC_RESUME_API_BASE_URL || "http://127.0.0.1:5000";
const API_BASE = process.env.NEXT_PUBLIC_RESUME_API_BASE_URL || "http://127.0.0.1:5000";
...
export default function ResumeDemo() {
  ...
  const handleUseSample = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || data.detail || "Demo failed.");
      }
