...
function DiagramFrame({
  ...
  return (
    <aside className="description-diagram-frame">
      <div className="description-diagram-header">
        <h4>{title}</h4>
        <a className="description-download-btn" href={href} download>
          Download SVG
        </a>
      </div>
      <div className="description-diagram-media">
        <img src={src} alt={alt} />
      </div>
    </aside>
  );
        ...
        {activeTab === "description" ? (
          <div className="description-layout">
            ...
            <div className="description-note cardish">
              ...
              purposes. The workflow, data, and results are fictional and are
