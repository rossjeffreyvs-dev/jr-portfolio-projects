const overviewItems = [
  { icon: "🚇", title: "Transit signal layer", text: "Line activity and train movement become the source data for the experience." },
  { icon: "🧠", title: "AI conductor", text: "A decision layer interprets density, activity, and tension before shaping the mix." },
  { icon: "🎷", title: "Generative ensemble", text: "Each subway line maps to an instrument family with overlapping, restrained voices." },
  { icon: "🗺️", title: "Visual map", text: "Animated train dots make the soundscape explainable instead of abstract." },
];
  ...
  return (
    <div className="content-grid">
      <section className="panel wide panel-accent-blue overview-panel">
        ...
        <h2 className="feature-title">Real-time subway activity as an explainable jazz system</h2>
        <p>
