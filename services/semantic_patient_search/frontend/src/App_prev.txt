...
import SemanticPatientSearchProjectDescription from "./components/SemanticPatientSearchProjectDescription";
import SemanticPatientSearchPMPlaybook from "./components/SemanticPatientSearchPMPlaybook";
      ...
      <main className="pageContainer">
        <section className="hero heroCentered">
          ...
          <p className="heroText heroTextCentered">
            ...
            natural language and semantic similarity rather than keyword-only
            matching.
          </p>
          ...
          <div className="tabNav" role="tablist">
            ...
            <button
              ...
              className={`tabButton ${activeTab === 'playbook' ? 'active' : ''}`}
        ...
        {activeTab === "description" ? (
          <SemanticPatientSearchProjectDescription />
        ) : activeTab === "playbook" ? (
          <SemanticPatientSearchPMPlaybook />
        ) : (
            ...
            <aside className="secondaryPanel">
              <div className="infoCard contentCard">
                ...
                <ul>
                  ...
                  <li>
                    Similarity ranking for discovery and cohort-building
                    workflows
                  </li>
                  <li>
              ...
              <div className="infoCard contentCard">
                ...
                <ol>
                  <li>
                    Select a sample query or enter your own clinical
                    description.
                  </li>
                  <li>
                    Run the search to rank semantically similar patient
                    profiles.
                  </li>
                  <li>
                    Review the returned diagnoses, medications, labs, and
                    explanation.
                  </li>
                </ol>
              </div>
