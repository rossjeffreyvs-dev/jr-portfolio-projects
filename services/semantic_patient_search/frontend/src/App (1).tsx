        ...
        <section className="dashboardGrid">
              ...
              {stage !== 'idle' ? (
                <div className="progressSection" aria-live="polite">
                  <div className="progressTrack" role="progressbar" aria-valuemin={0} aria-valuemax={100} aria-valuenow={progressValue}>
                    <div className={`progressFill ${loading ? 'is-animated' : ''}`} style={{ width: `${progressValue}%` }} />
                  </div>
          ...
          <aside className="secondaryPanel glassPanel">
            ...
            <div className="infoCard">
              ...
              <ol>
                <li>Convert each patient profile into a searchable narrative document.</li>
                <li>Embed the query and compare it to all patient profiles.</li>
                <li>Rank the most relevant matches using cosine similarity.</li>
                <li>Return results with scores and short match explanations.</li>
              </ol>
            </div>
